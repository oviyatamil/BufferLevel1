...
public class Analytics_Maintenance extends BasePage{
	...
	private By year = By.xpath("//div[text()=' 2022 ']/parent::button");
	...
	private By down = By.xpath("(//*[local-name()='g' and contains(@class,'plot-group')])[3]");
	private By other = By.xpath("(//fusioncharts)[3]");
