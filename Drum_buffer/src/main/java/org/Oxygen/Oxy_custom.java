...
public class Oxy_custom extends BasePage{

	public Oxy_custom(WebDriver driver) {
		super(driver);
	}
...
//			assertEquals(ExpectedURL, ActualURL);
	...
	public void report() {
			...
			try {
				...
				if(getCurrentURL().contains("/portal.careworx.in")) {
					click(monthly);
					...
					Thread.sleep(1000);
					click(loc);
					List<WebElement> l7 = findWebElements(loclist);
					l7.get(1).click();
					click(cat);	
					Thread.sleep(500);
					click(list2);
					...
					calendar(calendar, yeardd, year, startdate);
					click(site);
					List<WebElement> l6 = findWebElements(list);
