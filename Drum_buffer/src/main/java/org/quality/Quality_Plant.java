...
public class Quality_Plant extends BasePage {

	public Quality_Plant(WebDriver driver) {
		super(driver);
	}
	...
	private By machlist2 = By.xpath("//span[text()='Select Machine Name']/parent::mat-option/parent::div/mat-option");
